...
current_milestone = current_followers // milestone_increment
progress_in_milestone = current_followers - (current_milestone * milestone_increment)
...
next_milestone = (current_milestone + 1) * milestone_increment
followers_needed = next_milestone - current_followers
days_to_milestone = followers_needed // daily_average
